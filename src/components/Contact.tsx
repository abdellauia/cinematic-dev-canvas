...
const Contact = () => {
  ...
  return (
    <section id="contact" className="section-padding bg-gradient-to-b from-transparent to-black/50">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="glass-panel p-6">
              ...
              <div className="flex space-x-4 mt-6">
                <a href="#" className="bg-white/5 hover:bg-white/10 p-3 rounded-full transition-all duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-white/5 border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all duration-300"
              ...
              <div>
                <button
                  ...
                  className={`
                    glow-button w-full flex items-center justify-center
